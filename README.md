...
A detailed, technical overview of the event-driven vector search pipeline and performance optimizations can be found in the **[Vector Search Architecture Document](docs/vector_search_architecture.md)**.
